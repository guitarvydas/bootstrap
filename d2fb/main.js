...
function whole_makechildren (container) {
      var child1 = new connections (container, "connections");
        var child2 = new design_rule_edge_containment (container, "design rule edge containment");
        var child3 = new diagramparser (container, "diagramparser");
        var child4 = new asfactbase (container, "asfactbase");
        var child5 = new deleteblanklines (container, "deleteblanklines");
        var child6 = new sortForPROLOG (container, "sortForPROLOG");
        var child7 = new deleteTrailingSugar (container, "deleteTrailingSugar");
        var child8 = new kickStart (container, "kickStart");
        var child9 = new prolog_convert_to_json (container, "prolog convert to json");
        var child10 = new finish (container, "finish");
        var child11 = new kinds (container, "kinds");
        var child12 = new name (container, "name");
        var child13 = new color (container, "color");
        var child14 = new boundingbox (container, "boundingbox");
        var child15 = new styleexpander (container, "styleexpander");
        var child16 = new direction (container, "direction");
        var child17 = new contains (container, "contains");
        var child18 = new uncompress (container, "uncompress");
        var child19 = new contains_port (container, "contains port");
        var child20 = new direct_containment (container, "direct containment");
        var child21 = new edge_containment (container, "edge containment");
        var child22 = new sync_code (container, "sync code");
      var children = [ {name: "connections", runnable: child1}, {name: "design rule edge containment", runnable: child2}, {name: "diagramparser", runnable: child3}, {name: "asfactbase", runnable: child4}, {name: "deleteblanklines", runnable: child5}, {name: "sortForPROLOG", runnable: child6}, {name: "deleteTrailingSugar", runnable: child7}, {name: "kickStart", runnable: child8}, {name: "prolog convert to json", runnable: child9}, {name: "finish", runnable: child10}, {name: "kinds", runnable: child11}, {name: "name", runnable: child12}, {name: "color", runnable: child13}, {name: "boundingbox", runnable: child14}, {name: "styleexpander", runnable: child15}, {name: "direction", runnable: child16}, {name: "contains", runnable: child17}, {name: "uncompress", runnable: child18}, {name: "contains port", runnable: child19}, {name: "direct containment", runnable: child20}, {name: "edge containment", runnable: child21}, {name: "sync code", runnable: child22} ];
      return children;
}
...
function whole_makeconnections (container) {
    ...
    var conn24 = {sender:{name: "sync code", etag: "out"}, net: "NIY", receivers:  [{name: "connections", etag: "in"}] };
    var conn25 = {sender:{name: "connections", etag: "out"}, net: "NIY", receivers:  [{name: "design rule edge containment", etag: "in"}] };
    var conn26 = {sender:{name: "design rule edge containment", etag: "out"}, net: "NIY", receivers:  [{name: "prolog convert to json", etag: "in"}] };
    var conn27 = {sender:{name: "diagramparser", etag: "out"}, net: "NIY", receivers:  [{name: "styleexpander", etag: "in"}] };
    var conn28 = {sender:{name: "styleexpander", etag: "out"}, net: "NIY", receivers:  [{name: "asfactbase", etag: "in"}] };
    var conn29 = {sender:{name: "asfactbase", etag: "out"}, net: "NIY", receivers:  [{name: "deleteblanklines", etag: "in"}] };
    var conn30 = {sender:{name: "deleteblanklines", etag: "out"}, net: "NIY", receivers:  [{name: "sortForPROLOG", etag: "in"}] };
    var conn31 = {sender:{name: "sortForPROLOG", etag: "out"}, net: "NIY", receivers:  [{name: "deleteTrailingSugar", etag: "in"}] };
    var conn32 = {sender:{name: "kickStart", etag: "out"}, net: "NIY", receivers:  [{name: "uncompress", etag: "in"}] };
    var conn33 = {sender:{name: "deleteTrailingSugar", etag: "out"}, net: "NIY", receivers:  [{name: "kinds", etag: "in"}] };
    var conn34 = {sender:{name: "prolog convert to json", etag: "out"}, net: "NIY", receivers:  [{name: "finish", etag: "in"}] };
    var conn35 = {sender:{name: "kinds", etag: "out"}, net: "NIY", receivers:  [{name: "name", etag: "in"}] };
    var conn36 = {sender:{name: "name", etag: "out"}, net: "NIY", receivers:  [{name: "color", etag: "in"}] };
    var conn37 = {sender:{name: "color", etag: "out"}, net: "NIY", receivers:  [{name: "boundingbox", etag: "in"}] };
    var conn38 = {sender:{name: "boundingbox", etag: "out"}, net: "NIY", receivers:  [{name: "direction", etag: "in"}] };
    var conn39 = {sender:{name: "direction", etag: "out"}, net: "NIY", receivers:  [{name: "contains", etag: "in"}] };
    var conn40 = {sender:{name: "contains", etag: "out"}, net: "NIY", receivers:  [{name: "contains port", etag: "in"}] };
    var conn41 = {sender:{name: "contains port", etag: "out"}, net: "NIY", receivers:  [{name: "direct containment", etag: "in"}] };
    var conn42 = {sender:{name: "direct containment", etag: "out"}, net: "NIY", receivers:  [{name: "edge containment", etag: "in"}] };
    var conn43 = {sender:{name: "edge containment", etag: "out"}, net: "NIY", receivers:  [{name: "sync code", etag: "in"}] };
